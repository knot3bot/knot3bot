...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("knot3bot", .{
    ...
    // SQLite linking options
    const enable_sqlite = b.option(bool, "enable-sqlite", "Enable SQLite backend support (default: true)") orelse true;
    const sqlite_include_path = b.option([]const u8, "sqlite-include", "Path to SQLite headers (default: /usr/include)") orelse "/usr/include";
    const sqlite_lib_path = b.option([]const u8, "sqlite-lib", "Path to SQLite library (default: system default)");
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "knot3bot" is the name you will use in your source code to
                // import this module (e.g. `@import("knot3bot")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "knot3bot", .module = mod },
            },
        }),
    });
    ...
    // libvaxis — professional TUI library
